...
const CrossMarkAuth: React.FC = () => {
  ...
  return (
    <div className="container mx-auto mt-32 px-4">
        ...
        <div className="space-y-6 hero-text">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-lg">Fast Settlement</h3>
                <p className="text-sm opacity-70">Instant transactions on XRPL</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-70">Fully verifiable on-chain</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Stats Section */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mt-20 mb-10">
