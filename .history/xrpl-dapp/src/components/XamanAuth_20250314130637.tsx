...
const xumm = new XummPkce({
  apiKey: "bedfb834-633e-4443-9dcc-eebf2bfd9562",
...
const XamanAuth: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-background">
      <div className="backdrop-blur-glass bg-white/30 p-6 rounded-2xl shadow-glow text-center w-[400px] border border-white/40">
